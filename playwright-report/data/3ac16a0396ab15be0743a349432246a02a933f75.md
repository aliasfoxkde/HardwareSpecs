...
- Name: browse.spec.ts >> ComparePage >> loads empty state
- Location: e2e/browse.spec.ts:65:3
...
Locator: getByRole('heading', { name: /compare/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /compare/i })
