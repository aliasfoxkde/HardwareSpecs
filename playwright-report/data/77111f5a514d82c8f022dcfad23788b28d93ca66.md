...
- Name: browse.spec.ts >> DevicePage >> back to browse link works
- Location: e2e/browse.spec.ts:44:3
...
Locator: getByRole('link', { name: /back to browse/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: /back to browse/i })
...
- navigation "Main navigation":
  ...
  - 'button "Theme: auto. Click to switch."':
    - img
- main:
  - heading "Device Not Found" [level=1]
  - paragraph: The device you're looking for doesn't exist in our database.
  - link "Browse all devices →":
    - /url: /browse
